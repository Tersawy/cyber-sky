	...
	<SectionPage>
		<v-container class="mb-12">
			<v-layout row align-center justify-center style="height: 30rem;">
				...
				<v-col cols="12">
					<div v-if="!isloading">
						<h1 class="text-h3 mb-16" v-if="isError">Payment Failed</h1>
						<h1 v-else class="text-h3 mb-16">Successfuly payment card.</h1>
						<v-btn :to="{ name: 'UserCourse' }" plain link> My Profile </v-btn>
					</div>
