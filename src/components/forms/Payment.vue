  ...
  <v-form @submit.prevent='submit' ref='form'>
        ...
        >
            <v-tab-item value="cc">
                ...
                />
                <p class="text-h6"> 
                    اضغط على اكمل الطلب ليتم تحويلك الى صفحة الدفع 
                </p>
            </v-tab-item>
        ...
        <v-row class=mt-12>
            ...
            <template  v-if='!data.slug'>
                ...
                <v-col cols=2>
                    <v-btn outlined x-large :loading='isloading' height="100%" @click='checkCoupon'>
                        تحقق
                    </v-btn>
                </v-col>
            </template>
                ...
                <v-list-item-content >
                    <v-list-item-title>
                     ...
                     <v-list-item-subtitle v-if='data.slug'>
                        <strong class="text-h6 grey--text text--darken-4">
                            {{ meeting_price }}
                        </strong>
                         دولار
