          ...
          <v-col cols="12">
            ...
            <v-col cols=12>
                <vue-recaptcha 
                    ...
                    ref='recaptcha'
                    sitekey="6LdckecbAAAAAIV3GDus4EHLfoqOWhebNigOn5Oj"
                    @verify="validate"
                >
...
export default {
    ...
    methods: {
        submit() {
            ...
            this.isloading = true
            this.$store.dispatch("auth/login", fd)
                .then( ()=> {
        ...
        async google() {
            ...
            if (googleUser) {
                this.$store.dispatch("auth/social", {
                    type: "google",
        ...
        onFacebookLogin(data) {
            ...
            if (data.response) {
                data.FB.api("/me", 'GET', {fields: 'id,name,email'},
                    userInfo => {
