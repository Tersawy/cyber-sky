<template>
   <v-card flat color="#fff0" dir="ltr" >
        <h1 class="text-h4 mt-4">CYBER SKY PRIVACY NOTICE</h1> 
        <h1 class="text-subtitle-2 mb-4 mx-2">Last Updated Aug 2021</h1>
        <div class="text-body-1">
            <p class="text-subtitel-2">In Summary</p>
            <p class="text-body-1">
                When you interact with us, our websites or products and services, we collect and provide information about you that alone or when combined with other information, could be used to identify you (Personal Data
            </p>
            <p class="text-body-1">For the full version please continue reading.</p>
            <p class="text-body-1">Background to this Privacy Notice</p>
        </div>
        <div class="text-body-1">
            <p class="text-body-1">
            ...
            <p class="text-body-1">What this Privacy Notice does not apply to</p>
            <p class="text-body-1">This Privacy Notice does not apply to:</p>
            <div class="pl-5 mb-8">
                <ul>
            ...
            <p class="text-body-1">Personal Data we collect</p>
            <p class="text-body-1">Automatically Collected Data</p>
            <p class="text-body-1">When you access the Sites or use Products, the following Personal Data is created and automatically logged in our systems:</p>
            <div class="pl-5 mb-8">
                <ul>
                    <li class="text-body-1">Log data: Information that your browser automatically sends whenever you visit the Sites.  Log data includes your Internet Protocol address, browser type and settings, the date and time of your request, and how you interacted with the Sites or Products.</li>
                    <li class="text-body-1">
                ...
                <p class="text-body-1">We use various technologies to collect and store information, including cookies, pixel tags, local storage such as browser web storage or application data caches, databases and server logs.</p>
            </div>
            ...
            <div class="pl-7 mb-8">
                ...
                <p class="text-body-1">Personal Data we create or collect</p>
            </div>
            <p class="text-body-1"> We may create or collect the Personal Data about you in the following ways:</p>
            <div class="pl-7 mb-8">
                <ul>
                    <li class="text-body-1">
                        When you register to use Products, our systems will generate unique identifiers including your main Cyber Sky  ID (CSID), Purchase ID, Lab ID, Certificate ID, Video ID, system username and password.  These identifiers are known as “pseudonymized” personal data. They cannot alone identify you but can identify you when combined with other Personal Data we hold.
                    </li>
                    <li class="text-body-1">
            ...
            <p class="text-body-1"> Where we process your Personal Data</p>
            <p class="text-body-1"> We store and process your Personal Data on servers both within and outside the European Economic Area (the “EEA” which includes countries within the EU plus Iceland, Liechtenstein and Norway).   For example, outside the EEA we process Personal data on servers in the USA</p>
            <p class="text-body-1"> We try to protect the Personal Data from loss, misuse and unauthorized access, disclosure, alteration, or destruction.  However, no method of transmission over the internet is 100% secure</p>
            <p class="text-body-1 red--text"> Important note : CyberSky, Inc. is an US company that means We obey US laws in terms of any law enforcement asking for any personal data of any user we will provide them the data they want .   </p>
        </div>
